...
public class ConnectionWithMaximumStopUseCaseInput {

    private final String from;
    private final String to;
    private final Integer stops;

    private ConnectionWithMaximumStopUseCaseInput(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        ConnectionWithMaximumStopUseCaseInput that = (ConnectionWithMaximumStopUseCaseInput) o;
    ...
    public static class Builder {
        ...
        public Builder fromPrototype(ConnectionWithMaximumStopUseCaseInput prototype) {
            from = prototype.from;
            to = prototype.to;
        ...
        public ConnectionWithMaximumStopUseCaseInput build() {
            return new ConnectionWithMaximumStopUseCaseInput(this);
        }
    }
}
