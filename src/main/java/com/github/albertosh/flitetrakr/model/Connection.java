...
public class Connection {
    ...
    public static Connection fromString(String value) throws IllegalArgumentException {
        try {
            ...
            return new Builder()
                    .from(separatedValues[0])
                    .to(separatedValues[1])
                    .price(Integer.parseInt(separatedValues[2]))
                    // possible NumberFormatException
                    // will be catch in IllegalArgumentException
                    .build();
